...
<%if(gender.equals("Male") &&imgName==null){%>
 ...
 <form action="UploadImage" method="post" enctype="multipart/form-data">
    <input type="file" name="fileName" class="button" style="width:80px; background:#142170; " >
    <input type="submit" value="Upload" style="background: #142170; color: white; height: 30px; width:80px;">
</form>
...
<p><strong>Login Date:</strong><%=llogin %></p>
 ...
 <!--<p><a style='font-size:17px;' href='upload.jsp?id=<%=id%>'>Change Your Pic</a></p>-->
 <p><a style='font-size:17px;' href='uploadimg.jsp?id=<%=id%>'>Upload Images</a></p>
<p><a style='font-size:17px;' href='DeleteServlet?id=<%=id%>'><button style='background:#142170; color:white;'>Delete Profile</button></a></p>
